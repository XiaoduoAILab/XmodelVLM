...
python ${DATA_ROOT}/convert_answer_to_mme.py --data_path ${DATA_ROOT}/MME_Benchmark_release_version --experiment ${SAVE_PATH}/predictions
python ${DATA_ROOT}/eval_tool/calculation.py --results_dir ${SAVE_PATH}/predictions
