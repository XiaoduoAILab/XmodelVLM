...
from xmodelvlm import conversation as conversation_lib
from xmodelvlm.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from xmodelvlm.model.xmodel_lm import XmodelLMForCausalLM
from xmodelvlm.train.trainer import VLMTrainer
from xmodelvlm.utils import tokenizer_image_token
from xmodelvlm.train.flash_attention_patch import replace_with_flash_attention
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            if training_args.local_rank == 0:
                defined_name = 'XmodelLMForCausalLM'
                ckpt_path = model_args.model_name_or_path
            model = XmodelLMForCausalLM.from_pretrained(
