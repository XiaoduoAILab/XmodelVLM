...
from xmodelvlm.model.modeling_xmodel import (
    Attention,
    XModelForCausalLM,
    Model,
    RMSNorm,
...
def rms_norm_forward(self: RMSNorm, hidden_states: torch.Tensor) -> torch.Tensor:
    """
...
def replace_with_flash_attention(model: XModelForCausalLM) -> None:
